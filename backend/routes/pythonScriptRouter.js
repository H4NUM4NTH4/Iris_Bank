...
function runPythonScript() {
  const scriptPath = path.join('C:', 'Users', 'HP', 'Desktop', 'AIML', 'FYP', 'MAJOR_PROJECT', 'IrisRecognition_ML', 'src', 'CreateTemplate_DB.py');
  const scriptDirectory = path.join('C:', 'Users', 'HP', 'Desktop', 'AIML', 'FYP', 'MAJOR_PROJECT', 'IrisRecognition_ML', 'src');

 
//"F:\MAJOR_PROJECT\IrisRecognition_ML\src\CreateTemplate_DB.py"
