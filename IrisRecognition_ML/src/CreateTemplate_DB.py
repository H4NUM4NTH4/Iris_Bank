...
def parse_args():
    ...
    parser.add_argument("--dataset_dir", type=str, default=r"F:\MAJOR_PROJECT\IrisRecognition_ML\CASIA1",
                        help=r"Directory of the dataset (default: F:\MAJOR_PROJECT\IrisRecognition_ML\CASIA1)")
